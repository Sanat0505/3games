...
function preloadImgs() {
    var srcStrArray = ['img1.jpg', 'img2.jpg', 'img3.jpg', 'img4.jpg',
        ...
        'cartoon-sun-light.jpg', 'charusat1.png',
        'img11.jpg', 'charotar.jpg', 'charusat.jpg', 'aa22.jpg'
    ];
...
function initGameBgs() {
    gs.gameBgSrcArray = ['charotar.jpg', 'charusat1.png',
        'img11.jpg', 'charusat.jpg', 'aa22.jpg'
    ];
    gs.gameBgNb = 0;
...
function setGameBg() {
    ...
    if (gs.gameBgSrcArray[gs.gameBgNb] == 'charusat1.png') {
        document.getElementById('grid-container').style.backgroundSize = "450px";
    } else if (gs.gameBgSrcArray[gs.gameBgNb] == 'img11.jpg') {
